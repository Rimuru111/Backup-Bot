...
case 'tes': // 'tes' boleh kalian ganti terserah mau apa aja
wew = fs.readFileSync('./namafile/namafile') // wew nya bisa diganti namanya terserah // namafile nya ganti ke nama folder video, kalo nama file yg pertama itu video di taro folder mana nah terus namafilenya ganti ke nama folder yg ada video, nah namafile yg kedua itu nama dari video
...
case 'tes': // 'tes' boleh kalian ganti terserah mau apa aja
wew = fs.readFileSync('./namafile/namafile') // wew nya bisa diganti namanya terserah // namafile nya ganti ke nama folder audio, kalo nama file yg pertama itu audio di taro folder mana nah terus namafilenya ganti ke nama folder yg ada audio, nah namafile yg kedua itu nama dari audio
...
//// DIBAWAH YANG TXT
case 'tes': // 'tes' boleh kalian ganti terserah mau apa aja
wew = fs.readFileSync('./namafile/namafile') // wew nya bisa diganti namanya terserah // namafile nya ganti ke nama folder txtnya, kalo nama file yg pertama itu file txt di taro folder mana nah terus namafilenya ganti ke nama folder yg ada file txt, nah namafile yg kedua itu nama dari file txt
...
[ CASE BIASA ] ( VCARD / KONTAK )
case 'tes': // 'tes' boleh kalian ganti terserah mau apa aja
client.sendMessage(from, { displayname: "Jeff", vcard: (nama function vcardnya) }, MessageType.contact, { quoted: mek }) // (nama funtion vcardnya) ganti ke nama function vcardnya kalian bisa liat functionya di < Tutorial-Function-Dasar.js >
break
// client nya sesuain sama bot kalian y
